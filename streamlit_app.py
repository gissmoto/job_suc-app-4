...
# 페이지 선택
page_selection = st.sidebar.radio("페이지 선택", ["파일 업로드", "취업 성취 스코어", "그룹별 특성 상세 보기", "개인별 상세 분석"])
...
# Feature 중요도 시각화 함수 호출
    ...
    <div style="background-color: #333333; padding: 15px; border-radius: 8px; border-left: 5px solid #ff4b4b; margin-bottom: 15px;">
        ...
        <p style="margin-top: 10px;">
            <a href="#" style="color: #00BFFF; text-decoration: none; font-size: 14px;">관련 대학프로그램 검색</a>
        </p>
    </div>
    """,
